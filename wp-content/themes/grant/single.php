                    ...
                    <header class="mb-4 lg:mb-6 not-format">
                        <address class="flex items-center mb-6 not-italic">
                            <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                <div>
                                    <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white"><?= get_the_author(); ?></a>
                                    <!-- TODO: Add new Role field to users -->
                                    <p class="text-base text-gray-500 dark:text-gray-400">Graphic Designer, educator & CEO Flowbite</p>
                                    <p class="text-base text-gray-500 dark:text-gray-400"><time datetime="<?php echo get_the_date('c'); ?>" itemprop="datePublished"><?= $post_date ?></time></p>
                                </div>
                            </div>
                        </address>
            ...
            <div class="px-4 mx-auto max-w-screen-xl">
                ...
                <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                    <?php foreach ($posts as $post) :
                        ...
                        global $wp;
                        $currently_url = home_url($wp->request);

                    ?>
                        <article class="max-w-xs">
                            <a href="<?= $post_url ?>">
                                <!-- TODO: Add alt text -->
                                <img src="<?= $thumbnail ?>" class="mb-5 rounded-lg" alt="<?= $post->post_title ?>">
                            </a>
                            <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
                                <a href="<?= $post_url ?>"><?= $post->post_title ?></a>
                            </h2>
                            <p class="mb-4 text-gray-500 dark:text-gray-400"> <?= $post->post_excerpt ?> </p>
                            <a href="<?= $post_url ?>" class="inline-flex items-center font-medium underline underline-offset-4 text-blue-600 dark:text-blue-500 hover:no-underline">
                                <?= rtrim($currently_url, '/')  === rtrim($post_url, '/') ?  '<span class="text-blue-600">Reading</span>' :  '<span class="text-gray-900">Read more</span>' ?>
                            </a>
                        </article>
                    <?php endforeach ?>
                </div>
